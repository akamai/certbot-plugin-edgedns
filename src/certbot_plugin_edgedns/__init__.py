...
==========================================================  =============================================
``--edgedns-credentials``                                     Edge DNS Remote API credentials INI file.
``--edgedns-propagation-seconds``                             The number of seconds to wait for DNS to
                                                              propagate before asking the ACME server to
                                                              verify the DNS record. (Default: 180)
==========================================================  =============================================
...
.. code-block:: ini
   ...
   #edgerc_section = certbot

The path to this file can be provided interactively or using the
``--edgedns-credentials`` command-line argument. Certbot records the path
...
.. code-block:: bash
   :caption: To acquire a certificate for ``example.com``, waiting 900 seconds
             for DNS propagation
